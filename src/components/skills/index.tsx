...
export function Skills() {
  return (
    <section
      id="skills"
      className="mx-5 pb-96 pt-96 lg:container lg:w-full lg:max-w-7xl"
    >
      ...
      <div className="group relative w-fit">
        ...
        <div className="relative rounded-lg bg-white bg-gradient-to-r p-4 dark:bg-black">
          <h2 className="mb-3 flex flex-col items-end text-2xl font-extrabold text-slate-800 dark:bg-gradient-text-dark dark:bg-clip-text dark:text-neutral-100 dark:text-transparent lg:flex-row lg:items-center lg:gap-2">
            <VscTools className="text-slate-800 opacity-50 dark:text-zinc-50 lg:hidden" />
      ...
      <div className="group relative w-fit">
        ...
        <div className="relative rounded-lg bg-white bg-gradient-to-r p-4 dark:bg-black">
          <h2 className="mb-3 flex flex-col text-2xl font-extrabold text-slate-800 dark:bg-gradient-text-dark dark:bg-clip-text dark:text-neutral-100 dark:text-transparent lg:flex-row lg:items-center lg:gap-2">
            <LuLanguages className="text-slate-800 opacity-50 dark:text-zinc-50 lg:hidden" />
